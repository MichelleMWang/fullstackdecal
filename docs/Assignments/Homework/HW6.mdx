...
In `index.js`, you can now set the value of `API_KEY` to your newly generated API key. You will need to use it for the first part of the homework when making requests to the NASA API. 
